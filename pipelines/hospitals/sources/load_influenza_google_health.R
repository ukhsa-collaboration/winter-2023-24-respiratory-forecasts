load_influenza_google_health <- function(path, path_type, pattern, lookups) {
...
#### Data Collection ####
  ...
  # crude but works...until we have a proper now-cast
  # TODO: Do proper now-cast.
  n_repeats <- 2
